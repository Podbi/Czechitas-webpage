...
4. Použij proměnnou $totalPrice a při průchodu cyklem, který vypisuje položky, vždy připočítej cenu každé položky tak, abys nakonci po projití cyklu měla v proměnné celkovou cenu.
